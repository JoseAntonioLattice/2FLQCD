...
\begin{eqnarray}
    \left(F_{\text{f}}\right)^i_{x,\mu} & = & -2\re\left\{-\left[T^i\right]^{ab}U_{x,\mu}^{bc} \left(\frac{1-\gamma_{\mu}}{2}\right)_{\alpha\beta} \chi_{x+\hat{\mu},\beta}^c \left(\psi^{a}_{x,\alpha}\right)^*\right\} \\
     ...
     &  & -2\re \tr \left\{ U_{x,\mu}^{\dagger}T^i\left(\frac{1+\gamma_{\mu}}{2}\right)_{\alpha\beta} \left(\chi_{x,\beta}\otimes \psi_{x+\hat{\mu},\alpha}\right) \right \} 
\end{eqnarray}
Then
\begin{equation}
    \left(F_{\text{f}}\right)_{x,\mu} = \left\{-U_{x,\mu} \left(\frac{1-\gamma_{\mu}}{2}\right)_{\alpha\beta} \chi_{x+\hat{\mu},\beta}\otimes\psi^{\dagger}_{x,\alpha} + U_{x,\mu}^{\dagger}\left(\frac{1+\gamma_{\mu}}{2}\right)_{\alpha\beta}       \chi_{x,\beta}\otimes \psi^{\dagger}_{x+\hat{\mu},\alpha} \right\}_{\text{TA}}
\end{equation}
